        ...
        <tr>
          <td style="padding:32px 40px">
            ...
            <p style="margin:0 0 24px;font-size:14px;color:#9ca3af;line-height:1.6">
              Hi ${displayName}, thanks for signing up. Click the button below to verify your email address and activate your SessionForge account.
            </p>
            <a href="${verifyUrl}"
            ...
            <p style="margin:24px 0 0;font-size:13px;color:#6b7280;line-height:1.6">
              This link expires in 24 hours. If you didn't create a SessionForge account, you can safely ignore this email.
            </p>
        ...
        <tr>
          <td style="padding:20px 40px;border-top:1px solid #1e1e2e">
            <p style="margin:0;font-size:12px;color:#4b5563">
              SessionForge LLC · You're receiving this because you signed up for a SessionForge account.
            </p>
          </td>
        </tr>
      </table>
